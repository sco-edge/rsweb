...
def load(url, output):
    ...
    # output_for_url = os.path.join(args.output, url[:end_index + 1])
    ...
    commands = ["mm-webreplay", trace_output, "node", "../replay.js", "https://" + truncate_url(url, False)]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--timeout", "-t", default=120)
